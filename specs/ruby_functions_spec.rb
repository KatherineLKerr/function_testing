...
class FunctionsTest < MiniTest::Test
  ...
  def test_number_to_full_name__month_3()
    result = number_to_full_month_name_1( 3 )
    assert_equal( "March", result )
  end

  def test_number_to_full_name__month_9()
    result = number_to_full_month_name_2( 9 )
    assert_equal( "September", result )
  end

  def test_substring__month_1()
    first_month_string = number_to_short_month_name_3( 1 )
  ...
  def test_substring__month_10()
    tenth_month_string = number_to_short_month_name_5( 10 )
  ...
  def test_volume_of_cube()
    volume =  volume_of_cube(10,10,10)
    assert_equal(1000, volume)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume = volume_of_sphere(9.7)
    assert_equal(3823, volume )
  end

  # Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    celsius = fahrenheit_to_celsius(5)
    assert_equal(-15, celsius)
  end
